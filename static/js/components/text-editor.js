...
class TextEditor {
  ...
  `;
    ...
    setupDOM() {
        ...
        // POPRAWKA: Lepsze wyszukiwanie textarea
        if (this.elements.editArea) {
            // Spróbuj znaleźć textarea w różny sposób
            this.elements.textarea = this.elements.editArea.querySelector('textarea') ||
                this.elements.editArea.querySelector('#textEditArea') ||
                this.container.querySelector('#textEditArea');
        }

        // Jeśli nadal nie ma textarea, stwórz go
        if (!this.elements.textarea) {
            console.warn('Textarea not found, creating new one');
    ...
    enterEditMode() {
        ...
        // ZABEZPIECZENIE: Sprawdź czy wszystkie elementy istnieją
        if (!this.elements.textarea) {
            console.error('Textarea not found! Cannot enter edit mode. Elements:', {
        ...
        if (!this.elements.editArea || !this.elements.displayArea) {
